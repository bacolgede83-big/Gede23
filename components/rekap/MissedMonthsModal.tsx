...
interface MissedMonthsModalProps {
    isOpen: boolean;
    onClose: () => void;
    rekapData: RekapData | null;
}

const MissedMonthsModal: React.FC<MissedMonthsModalProps> = ({ isOpen, onClose, rekapData }) => {
            ...
            >
                <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                       ...
                       <div>
                           <h3 className="text-xl font-semibold text-white">Detail Bulan Belum Bayar</h3>
                ...
                <p className="text-gray-300 mb-4">Berikut adalah daftar bulan di tahun ini yang belum dibayar:</p>
                ...
                <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700 max-h-60 overflow-y-auto">
                    <ul className="list-disc list-inside space-y-2 text-red-300">
                        {rekapData.missedMonths.map(month => (
...
export default MissedMonthsModal;